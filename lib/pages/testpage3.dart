...
class testGamma extends StatefulWidget {
  @override
  _testGammaState createState() => _testGammaState();
}

class _testGammaState extends State<testGamma> {
  @override
  void initState() {
              ...
              return Column(
                children: <Widget>[
                  ...
                  FutureBuilder<List<String>>(
                      future: gettingSpecialist(alphabets[index]),
                              ...
                              return Container(
                                ...
                                child: FlatButton(
                                  child: Padding(
                                    ...
                                    child: Align(alignment: Alignment.center,child: Text('${snap.data[index1]}',style: TextStyle(color: Colors.white,fontSize: 13,fontWeight: FontWeight.bold),)),
                                  ),
                                  onPressed: (){
